class Dice {
    ...
    bctns = new Array();
    roll() {
        // Update the message and die colors based on the player type
        if (this.type == 1) {
            msg.innerHTML = "Red";
            msg.style.color = "Red";
            document.getElementById("die").style.border = "5px solid Red";
            document.body.style.backgroundColor = "red"; // Change background to Red

        } else if (this.type == 2) {
            msg.innerHTML = "Green";
            msg.style.color = "Green";
            document.getElementById("die").style.border = "5px solid Green";
            document.body.style.backgroundColor = "green";
        } else if (this.type == 3) {
            msg.innerHTML = "Yellow";
            msg.style.color = "rgb(255, 200, 0)";
            document.getElementById("die").style.border = "5px solid rgb(255, 200, 0)";
            document.body.style.backgroundColor = "rgb(255, 200, 0)"; // Change background to Yellow

        } else if (this.type == 4) {
            msg.innerHTML = "Blue";
            msg.style.color = "Blue";
            document.getElementById("die").style.border = "5px solid Blue";
        ...
        // Update the dice image based on the number rolled
        if (this.count == 1) {
            document.getElementById("die").style.backgroundImage = "url('src-20241213T052447Z-001/src/one.png')";
        } else if (this.count == 2) {
            document.getElementById("die").style.backgroundImage = "url('src-20241213T052447Z-001/src/two.png')";
        } else if (this.count == 3) {
            document.getElementById("die").style.backgroundImage = "url('src-20241213T052447Z-001/src/three.png')";
        } else if (this.count == 4) {
            document.getElementById("die").style.backgroundImage = "url('src-20241213T052447Z-001/src/four.png')";
        } else if (this.count == 5) {
            document.getElementById("die").style.backgroundImage = "url('src-20241213T052447Z-001/src/five.png')";
        } else if (this.count == 6) {
            document.getElementById("die").style.backgroundImage = "url('src-20241213T052447Z-001/src/six.png')";
        }
    
        // Handle the dice logic based on the rolled value for each player type
        if (this.type == 1) {
            if (this.r.checker()) {
